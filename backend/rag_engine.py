...
_SYSTEM_PROMPT_TMPL = (
    ...
    "acknowledgment, etc.) — do NOT apply the report-grounding rules below, do NOT say data is "
    "unavailable, do NOT generate a chart. Keep it to one short sentence, chartType/chartData both null.\n\n"
